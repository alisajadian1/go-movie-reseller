...
const file_internal_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x19internal/proto/user.proto\x12\x06userpb\"F\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1a\n" +
	"\busername\x18\x03 \x01(\tR\busername\" \n" +
	"\x06UserId\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\x04R\x06userId26\n" +
	"\vUserService\x12'\n" +
	"\aGetUser\x12\x0e.userpb.UserId\x1a\f.userpb.UserB\x19Z\x17./internal/proto/userpbb\x06proto3"
...
var file_internal_proto_user_proto_goTypes = []any{
	...
	(*UserId)(nil), // 1: userpb.UserId
}
var file_internal_proto_user_proto_depIdxs = []int32{
	1, // 0: userpb.UserService.GetUser:input_type -> userpb.UserId
	0, // 1: userpb.UserService.GetUser:output_type -> userpb.User
